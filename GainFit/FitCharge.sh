...
if [ ! -d "$cwd/"$hist_dir"/"$method_dir"/3075PE" ]; then
		mkdir $cwd/"$hist_dir"/"$method_dir"/3075PE
fi

if [ ! -d "$cwd/"$hist_dir"/"$method_dir"/6075PE" ]; then
		mkdir $cwd/"$hist_dir"/"$method_dir"/6075PE
fi

if [ ! -d "$cwd/"$hist_dir"/"$method_dir"/6050PE" ]; then
		mkdir $cwd/"$hist_dir"/"$method_dir"/6050PE
fi
