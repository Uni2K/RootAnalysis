...
int amp_array_printRate = 20000;
int wavesPrintRate = 20000;
// clibrated sum

int ch0PrintRate = 20000;
int trigPrintRate = 20000;   //100
int signalPrintRate = 50000; //100
...
void readFast(TString _inFileList, TString _inDataFolder, TString _outFileFolder, string _runName, string dynamicBL_, string isDC_, string useCalibValues_)
{
  ...
  TString _outFile=(_outFileFolder+"/out.root");
  TString plotSaveFolder  = _outFileFolder;
  ...
  cout << "inFileList: " << _inFileList << endl;
  cout << "inDataFolder: " << _inDataFolder << endl;
  ...
  */
  ...
  if ((strcmp(_runName.c_str(), "calib_vb56") == 0) || (strcmp(_runName.c_str(), "dc_vb56") == 0))
  {
  ...
  if (isDC)
  {
    amp_array_printRate = 10000;
    wavesPrintRate = 10000;
  }
  else
  {
    amp_array_printRate = 20000;
    wavesPrintRate = 20000;
  }
